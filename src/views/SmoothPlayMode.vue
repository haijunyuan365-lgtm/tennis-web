  ...
  <div class="tennis-container">
    ...
    <el-row class="top-bar" type="flex" justify="space-between" align="middle">
      ...
      <el-col :span="8" class="center-section">
        <div class="match-mode-tag"><span class="match-text">畅打模式({{ gameMode }})</span></div>
      </el-col>
    ...
    <el-row class="middle-section">
      ...
      <el-col :span="12" class="data-table-container">
        <div class="table-wrapper">
          ...
          <!-- 表格主体 -->
          <el-table ref="tennisTable" :data="tableData" border height="calc(100% - 90px)" highlight-current-row
...
export default {
  ...
  methods: {
    ...
    drawPoints(ctx, points) {
      ...
      // 绘制选中点
      const selectedPoint = points.find(p => p.id === this.currentSelectedRow.id);
      if (selectedPoint) {
